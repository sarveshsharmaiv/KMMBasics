...
//        mediaManager = MediaManager(withView: cell.templateImgView)
//        let resourceURL = self.templates[indexPath.row].previewList.story["default"]?.previewURL ?? ""
//        self.mediaManager?.playVideo(withURL: URL(string: resourceURL)!, andKey: String(self.templates[indexPath.row].templateID))
//    }
