...
@class SharedDatabaseDriverFactory, SharedTemplate, SharedTemplate_, SharedRuntimeQuery<__covariant RowType>, SharedTemplateResources, SharedPreviewList, SharedKotlinThrowable, SharedKotlinArray<T>, SharedRuntimeTransacterTransaction, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinByteArray, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinByteIterator;
...
__attribute__((swift_name("TemplatesSDK")))
@interface SharedTemplatesSDK : SharedBase
...
*/
- (void)getTemplatesForceReload:(BOOL)forceReload completionHandler:(void (^)(NSArray<SharedTemplate *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getTemplates(forceReload:completionHandler:)")));
@end;
...
@required
- (void)insertTemplatesSeoID:(int64_t)seoID dimension:(NSString *)dimension categoryID:(int32_t)categoryID templateID:(int64_t)templateID previewURL:(NSString * _Nullable)previewURL thumbnailURL:(NSString * _Nullable)thumbnailURL websiteThumbnailURL:(NSString * _Nullable)websiteThumbnailURL defaultPreviewURL:(NSString * _Nullable)defaultPreviewURL defaultThumbnailURL:(NSString * _Nullable)defaultThumbnailURL defaultWebsiteThumbnailURL:(NSString * _Nullable)defaultWebsiteThumbnailURL __attribute__((swift_name("insertTemplates(seoID:dimension:categoryID:templateID:previewURL:thumbnailURL:websiteThumbnailURL:defaultPreviewURL:defaultThumbnailURL:defaultWebsiteThumbnailURL:)")));
- (void)removeAllTemplates __attribute__((swift_name("removeAllTemplates()")));
- (SharedRuntimeQuery<SharedTemplate_ *> *)selectAllTemplates __attribute__((swift_name("selectAllTemplates()")));
- (SharedRuntimeQuery<id> *)selectAllTemplatesMapper:(id (^)(SharedLong *, NSString *, SharedInt *, SharedLong *, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable))mapper __attribute__((swift_name("selectAllTemplates(mapper:)")));
- (SharedRuntimeQuery<SharedTemplate_ *> *)selectTemplateByIdTemplateID:(int64_t)templateID __attribute__((swift_name("selectTemplateById(templateID:)")));
- (SharedRuntimeQuery<id> *)selectTemplateByIdTemplateID:(int64_t)templateID mapper:(id (^)(SharedLong *, NSString *, SharedInt *, SharedLong *, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable))mapper __attribute__((swift_name("selectTemplateById(templateID:mapper:)")));
@end;
...
@interface SharedTemplate_ : SharedBase
- (instancetype)initWithSeoID:(int64_t)seoID dimension:(NSString *)dimension categoryID:(int32_t)categoryID templateID:(int64_t)templateID previewURL:(NSString * _Nullable)previewURL thumbnailURL:(NSString * _Nullable)thumbnailURL websiteThumbnailURL:(NSString * _Nullable)websiteThumbnailURL defaultPreviewURL:(NSString * _Nullable)defaultPreviewURL defaultThumbnailURL:(NSString * _Nullable)defaultThumbnailURL defaultWebsiteThumbnailURL:(NSString * _Nullable)defaultWebsiteThumbnailURL __attribute__((swift_name("init(seoID:dimension:categoryID:templateID:previewURL:thumbnailURL:websiteThumbnailURL:defaultPreviewURL:defaultThumbnailURL:defaultWebsiteThumbnailURL:)"))) __attribute__((objc_designated_initializer));
...
- (SharedTemplate_ *)doCopySeoID:(int64_t)seoID dimension:(NSString *)dimension categoryID:(int32_t)categoryID templateID:(int64_t)templateID previewURL:(NSString * _Nullable)previewURL thumbnailURL:(NSString * _Nullable)thumbnailURL websiteThumbnailURL:(NSString * _Nullable)websiteThumbnailURL defaultPreviewURL:(NSString * _Nullable)defaultPreviewURL defaultThumbnailURL:(NSString * _Nullable)defaultThumbnailURL defaultWebsiteThumbnailURL:(NSString * _Nullable)defaultWebsiteThumbnailURL __attribute__((swift_name("doCopy(seoID:dimension:categoryID:templateID:previewURL:thumbnailURL:websiteThumbnailURL:defaultPreviewURL:defaultThumbnailURL:defaultWebsiteThumbnailURL:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t categoryID __attribute__((swift_name("categoryID")));
@property (readonly) NSString * _Nullable defaultPreviewURL __attribute__((swift_name("defaultPreviewURL")));
@property (readonly) NSString * _Nullable defaultThumbnailURL __attribute__((swift_name("defaultThumbnailURL")));
@property (readonly) NSString * _Nullable defaultWebsiteThumbnailURL __attribute__((swift_name("defaultWebsiteThumbnailURL")));
@property (readonly) NSString *dimension __attribute__((swift_name("dimension")));
@property (readonly) NSString * _Nullable previewURL __attribute__((swift_name("previewURL")));
@property (readonly) int64_t seoID __attribute__((swift_name("seoID")));
@property (readonly) int64_t templateID __attribute__((swift_name("templateID")));
@property (readonly) NSString * _Nullable thumbnailURL __attribute__((swift_name("thumbnailURL")));
@property (readonly) NSString * _Nullable websiteThumbnailURL __attribute__((swift_name("websiteThumbnailURL")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getAllTemplatesWithCompletionHandler:(void (^)(NSArray<SharedTemplate *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getAllTemplates(completionHandler:)")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PreviewList")))
@interface SharedPreviewList : SharedBase
- (instancetype)initWithStory:(NSDictionary<NSString *, SharedTemplateResources *> *)story __attribute__((swift_name("init(story:)"))) __attribute__((objc_designated_initializer));
- (NSDictionary<NSString *, SharedTemplateResources *> *)component1 __attribute__((swift_name("component1()")));
- (SharedPreviewList *)doCopyStory:(NSDictionary<NSString *, SharedTemplateResources *> *)story __attribute__((swift_name("doCopy(story:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSDictionary<NSString *, SharedTemplateResources *> *story __attribute__((swift_name("story")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PreviewList.Companion")))
@interface SharedPreviewListCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithSeoID:(int64_t)seoID dimension:(NSString *)dimension templateID:(int64_t)templateID categoryID:(int32_t)categoryID previewList:(SharedPreviewList *)previewList __attribute__((swift_name("init(seoID:dimension:templateID:categoryID:previewList:)"))) __attribute__((objc_designated_initializer));
- (int64_t)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (int64_t)component3 __attribute__((swift_name("component3()")));
- (int32_t)component4 __attribute__((swift_name("component4()")));
- (SharedPreviewList *)component5 __attribute__((swift_name("component5()")));
- (SharedTemplate *)doCopySeoID:(int64_t)seoID dimension:(NSString *)dimension templateID:(int64_t)templateID categoryID:(int32_t)categoryID previewList:(SharedPreviewList *)previewList __attribute__((swift_name("doCopy(seoID:dimension:templateID:categoryID:previewList:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t categoryID __attribute__((swift_name("categoryID")));
@property (readonly) NSString *dimension __attribute__((swift_name("dimension")));
@property (readonly) SharedPreviewList *previewList __attribute__((swift_name("previewList")));
@property (readonly) int64_t seoID __attribute__((swift_name("seoID")));
@property (readonly) int64_t templateID __attribute__((swift_name("templateID")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TemplateResources")))
@interface SharedTemplateResources : SharedBase
- (instancetype)initWithPreviewURL:(NSString * _Nullable)previewURL thumbnailURL:(NSString * _Nullable)thumbnailURL websiteThumbnailURL:(NSString * _Nullable)websiteThumbnailURL __attribute__((swift_name("init(previewURL:thumbnailURL:websiteThumbnailURL:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (SharedTemplateResources *)doCopyPreviewURL:(NSString * _Nullable)previewURL thumbnailURL:(NSString * _Nullable)thumbnailURL websiteThumbnailURL:(NSString * _Nullable)websiteThumbnailURL __attribute__((swift_name("doCopy(previewURL:thumbnailURL:websiteThumbnailURL:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable previewURL __attribute__((swift_name("previewURL")));
@property (readonly) NSString * _Nullable thumbnailURL __attribute__((swift_name("thumbnailURL")));
@property NSString * _Nullable websiteThumbnailURL __attribute__((swift_name("websiteThumbnailURL")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TemplateResources.Companion")))
@interface SharedTemplateResourcesCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
